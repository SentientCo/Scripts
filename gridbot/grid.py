...
def Grid():
    ...
    while True:
        try:
            ...
            print("Crypto Balance:",new_balance)
            ...
            if new_balance > init_investment:     
                ...
                while flipper: 
                    ...
                    if percentage_gap <= sell_gap: #Adjust this as needed 
